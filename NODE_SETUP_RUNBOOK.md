...
> DAD off + `mld_max_msf=1` (`/etc/sysctl.d/98-netrun-ipv6.conf`) теперь ставит **`install_node_v2.sh`** (`configure_sysctl`) — раньше ручной твик, выявлен аудитом нод 2026-05-30. `node_followup_v2.sh` его НЕ трогает.
